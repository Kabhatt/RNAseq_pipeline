...
cd /Users/kashishbhatt/Desktop/Desktop\ -\ Kashish’s\ MacBook\ Air/Codes\ /RNAseq_pipeline
...
java -jar /Applications/Trimmomatic/trimmomatic-0.39.jar SE -threads 4 data/demo.fastq data/demo_trimmed.fastq TRAILING:10 -phred33
